...
var PromptTestData = []PromptTestDatum{
	...
	// {UserInput: "monitor CPU and memory usage and alert if too high", WantedFunctionName: "printz"}, // this one is 50/50 printz info w/ 3.5 TODO
	...
	// info
	{UserInput: "What color is an elephant?", WantedFunctionName: "info"},
	{UserInput: "how many quarts are in a gallon", WantedFunctionName: "info"},
	{UserInput: "how many US presidents have there been", WantedFunctionName: "info"},
	{UserInput: "What color is a penguin?", WantedFunctionName: "info"},
	{UserInput: "What color is a lion?", WantedFunctionName: "info"},
